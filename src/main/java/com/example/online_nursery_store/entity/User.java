...
public class User implements UserDetails {
    @Id
    @SequenceGenerator(name = "iv_user_seq_gen", sequenceName = "iv_user_id_seq", allocationSize = 1)
    @GeneratedValue(generator = "iv_user_seq_gen", strategy = GenerationType.SEQUENCE)
    private Integer id;
